 ...
 * @return {Promise<void>}
 */
export const showMessageBox = async ({ title = t('core.messages.errorTitle'), message, type = ResponseStatus.error, callback = null }) => {
 ...
 * @return {void}
 */
export const showNotification = ({ title = t('core.messages.errorTitle'), message, type = ResponseStatus.error }) => {
  ElNotification({
    title: title,
    message: message,
    type: type,
 ...
 * @return {void}
 */
export const showConfirmMessageBox = async ({ title, message, callback, cancelMessage = t('core.messages.cancelDefaultMessage') }) => {
